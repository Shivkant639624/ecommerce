...
def checkout(request):
    ...
    if request.method == "POST":
        ...
        # Generate the order ID (with "ShopyCart" appended)
        Order.order_id = str(Order.pk) + "ShopyCart"  # Set the order_id field here
...
def profile(request):
    ...
    # Check if rid is a valid integer before querying
    if rid.isdigit():
